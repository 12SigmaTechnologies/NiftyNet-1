...
class UNet3D(TrainableLayer):
    ...
    def layer_op(self, images, is_training=True, layer_id=-1, **unused_kwargs):
        ...
        block_layer = UNetBlock('DOWNSAMPLE',
                                ...
                                acti_func=self.acti_func,
                                name='L5')
        pool_5, conv_5 = block_layer(pool_4, is_training)
        print(block_layer)
		#############
        ...
        block_layer = UNetBlock('UPSAMPLE',
                                ...
                                acti_func=self.acti_func,
                                name='R6')
        up_5, _ = block_layer(pool_5, is_training)
        print(block_layer)
        ...
        block_layer = UNetBlock('UPSAMPLE',
                                ...
                                acti_func=self.acti_func,
                                name='R5')
        concat_5 = ElementwiseLayer('CONCAT')(conv_5, up_5)
        up_4, _ = block_layer(concat_5, is_training)
        print(block_layer)
        ...
        up_3, _ = block_layer(concat_4, is_training)
        print(block_layer)
